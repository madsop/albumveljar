...
public class BasicPlayerTest implements BasicPlayerListener
{
	...
	public final static String EOM_PROPERTY = "EOM";
	public final static String BAR_PROPERTY = "BAR";
	...
	public void progress(int bytesread, long microseconds, byte[] pcmdata, Map properties)
	{
		...
		pcs.firePropertyChange(BAR_PROPERTY,null,microseconds);
	}
	...
	public void stateUpdated(BasicPlayerEvent event)
	{
		...
		if (event.getCode()==BasicPlayerEvent.EOM)
		{
			if (player.getStatus() == BasicPlayer.PLAYING) {
				...
				pcs.firePropertyChange(EOM_PROPERTY, null, null);
			}
		}
	}
